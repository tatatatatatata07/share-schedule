...
contents = ["1Fミーティングルームにて","2社の営業予定","今月の実績と来月の目標を共有","2Fミーティングルームにて予定","消耗品到着の予定","先日の打ち合わせの結果を報告予定","新入社員説明会予定日","説明会資料の作成を予定","燃えるゴミと不燃ゴミの日","第二営業所へOJT予定","新入社員教育の予定","結婚式のため","資格の試験日のため","子供の迎えのため早退予定","病院へ行ってから出社します","本社にて研修予定","プロジェクト途中参加の○○さん歓迎会","サーバーメンテナンス定例作業","〇社向け営業資料の作成締め日","19時○○時より開始予定"]
