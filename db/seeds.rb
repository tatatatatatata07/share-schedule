...
contens = ["1Fミーティングルームにて","2社の営業予定","今月の実績と来月の目標を共有","2Fミーティングルームにて予定","消耗品到着の予定","先日の打ち合わせの結果を報告予定","新入社員説明会予定日","説明会資料の作成を予定","燃えるゴミと不燃ゴミの日","第二営業所へOJT予定","新入社員教育の予定""休暇","有給休暇","早退予定","遅刻予定","帰社","歓迎会","月次作業","資料締切日","新入社員歓迎会","休暇","有給休暇","早退予定","遅刻予定","帰社","歓迎会","月次作業","資料締切日","新入社員歓迎会"]
50.times do
